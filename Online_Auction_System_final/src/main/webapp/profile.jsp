        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="profileNav">
                <div class="navbar-nav w-100 justify-content-between">
                    <a class="nav-link btn btn-outline-primary mx-1 my-1" href="${pageContext.request.contextPath}/about-us.jsp">
                        <i class="bi bi-info-circle"></i> About Us
                    </a>
                    <a class="nav-link btn btn-outline-info mx-1 my-1" href="${pageContext.request.contextPath}/view-products.html">
